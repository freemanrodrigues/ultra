...
use App\Models\{BottleType,Sample,SampleDetail,SiteMachineDetail, SampleType,SampleNature};
...
class SampleDetailController extends Controller
{
    ...
    public function addSampleDetials($id):View
    {
        ...
        $devices = SiteMachineDetail::getSiteDeviceList($sample[0]->site_master_id);
