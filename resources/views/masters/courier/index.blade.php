...
<style>
    /* Consistent styling for courier page - Optimized for viewport */
    .courier-page {
    ...
    .courier-page .form-control,
    .courier-page .form-select,
    .courier-page .btn {
...
<div class="container-fluid courier-page">
    <!-- Page Header with distinct background -->
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <h1>
                <i class="fas fa-shipping-fast me-2"></i> Courier Management
                <small class="d-block d-md-inline ms-md-2 opacity-75">({{ $couriers->total() }} total)</small>
            </h1>
        </div>
    </div>
    ...
    <!-- Search and Filter Form with Add New Courier inline -->
    <div class="card shadow-sm compact-form">
        <div class="card-body py-2">
            <form method="GET" action="{{ route('courier.index') }}" class="row g-2 form-row-aligned">
                <div class="col-md-4">
                    <div class="input-group position-relative">
                        <input type="text" class="form-control search" id="search" name="search" 
                               ...
                               data-txt_id="courier_id" autocomplete="off">
                ...
                <div class="col-md-3">
                    <a href="{{ route('courier.create') }}" class="btn btn-primary w-100">
                        <i class="fas fa-plus me-2"></i>
                        <i class="fas fa-shipping-fast me-1"></i> Add New Courier
                    </a>
                </div>
            </form>
        </div>
                ...
                <div class="table-responsive compact-table">
                    <table class="table table-hover mb-0 table-striped table-compact">
                        <thead class="table-light">
                            <tr>
                                <th width="10%">ID</th>
                                <th width="20%">Courier Code</th>
                                <th width="40%">Courier Name</th>
                        ...
                        <tbody id="tbody_customer_index">
                            ...
                            <tr>
                                <td>{{ str_pad($courier->id, 5, '0', STR_PAD_LEFT) }}</td>
                                <td>
