        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">
                        <i class="fas fa-plus-circle text-primary"></i> Edit Courier Master
                    </h4>
                ...
                <form action="{{ route('courier.update',$courier->id) }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="courier_code" 
                                       name="courier_code" 
                                       value="{{ old('courier_code')??$courier->courier_code }}" 
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="1" {{ (old('status')??$courier->status ) == 1 ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option value="0" {{ (old('status')??$courier->status ) == 0 ? 'selected' : '' }}>
                                        Inactive
                                    </option>
                                </select>
                                @error('status')
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Update Courier Master
                        </button>
                        <a href="{{ route('courier.index') }}" class="btn btn-outline-secondary">
