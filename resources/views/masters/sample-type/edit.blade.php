    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('sample-type.update',$sampleType->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('sample_type_code')??$sampleType->sample_type_code }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   value="{{ old('sample_type_name')??$sampleType->sample_type_name }}" 
                    ...
                    <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="remark" 
                                   name="remark" 
                                   value="{{ old('remark')??$sampleType->remark }}" 
                                   placeholder="Enter sample_type name"
                                   maxlength="255"
                                   required>
                            @error('remark')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="mis_group" 
                                   name="mis_group" 
                                   value="{{ old('mis_group')??$sampleType->mis_group }}" 
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Update Sample Type Master
                            </button>
