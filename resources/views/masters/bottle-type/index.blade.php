...
<div class="container-fluid bottle-type-page">
    ...
    <div class="page-header">
        <div class="d-flex justify-content-between align-items-center">
            <h1>
                <i class="fas fa-wine-bottle me-2"></i> Bottle Type Management
                <small class="d-block d-md-inline ms-md-2 opacity-75">({{ $bottle_types->total() }} total)</small>
            </h1>
        </div>
    </div>
    ...
    <!-- Search and Filter Form with Add New Bottle Type inline -->
    <div class="card shadow-sm compact-form">
        <div class="card-body py-2">
            <form method="GET" action="{{ route('bottle-type.index') }}" class="row g-2 form-row-aligned">
                <div class="col-md-4">
                ...
                <div class="col-md-3">
                    <a href="{{ route('bottle-type.create') }}" class="btn btn-primary w-100">
                ...
                <div class="table-responsive compact-table">
                    <table class="table table-hover mb-0 table-striped table-compact">
                        <thead class="table-light">
                            <tr>
                                <th width="10%">ID</th>
                                <th width="20%">Bottle Code</th>
                                <th width="40%">Bottle Name</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <small class="text-muted">
                                        @if(!empty($bottle_type->created_at))
                                            {{ $bottle_type->created_at->format('M d, Y') }}
                                        @endif
                                    </small>
                                </td>
                                <td>
                ...
                @if($bottle_types->hasPages())
                    <div class="card-footer">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            {{ $bottle_types->links('pagination::bootstrap-5') }}
                        </div>
                    </div>
                @endif 
            @else
