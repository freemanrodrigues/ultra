...
<div class="container mt-4">
 <!-- Search and Filter Form --><div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">
        <i class="fas fa-building text-primary"></i> Nature of Sample
        <small class="text-muted">({{ $sample_natures->total() }} total)</small>
    </h1>
...
<div class="search-form">
    <form method="GET" action="{{ route('sample-nature.index') }}">
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge status-badge {{ $sample_nature->status == 1 ? 'bg-success' : 'bg-secondary' }}">
                                    <i class="fas {{ $sample_nature->status == 1 ? 'fa-check' : 'fa-times' }}"></i>
                                    {{ ucfirst($sample_nature->status) }}
                                </span>
                            </td>
                            <td>
                                <small class="text-muted">@if(!empty($sample_nature->created_at)){{ $sample_nature->created_at->format('M d, Y') }} @endif</small>
                            </td>
                            <td>
