        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Edit Brand Master: {{ $brand->brand_code }}</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('brand.update', $brand) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="Enter unique brand code"
                                   maxlength="50"
                                   required>
                            @error('brand_code')
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-circle"></i> Update Brand Master
                            </button>
                            <a href="{{ route('brand.show', $brand) }}" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <strong>@if(!empty($brand->created_at)) {{ $brand->created_at->format('M d, Y h:i') }} @endif
                        </div>    
                    </div>    
                 </div>    
            </div> 
